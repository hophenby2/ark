...
app.add_url_rule("/activity/getChainLogInReward", methods=["POST"], view_func=activity.getChainLogInReward)
app.add_url_rule("/activity/getOpenServerCheckInReward", methods=["POST"], view_func=activity.getOpenServerCheckInReward)
app.add_url_rule("/activity/getChainLogInFinalRewards", methods=["POST"], view_func=activity.getChainLogInFinalRewards)
